...
var (
	...
	banner = fmt.Sprintf(`
       ...
       [-] Sharkc2p Termux version
       [-] Support HTTP/1.1
       [-] Support HTTP/2.0
       [-] Cannot down sites like nasa.gov
       
       Take down the NASA site using the method
    [-] github.com/DDoS-Leaks/TLS-FLOODER/

    [-] Use the tls-flooder method to get full power  `)
